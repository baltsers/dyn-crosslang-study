...
if [ -f "./build/temp.linux-x86_64-2.7/bson/time64.o" ]; then
#if [ $? -eq 0 ]; then
    ...
    # scripts.
		...
		md5sum ./build/temp.linux-x86_64-2.7/bson/time64.o # buffer _cbsonmodule time64 encoding_helpers _cmessagemodule
	#else
		#echo FAIL
	#fi
else
