...
if [ -f "./build/lib.linux-x86_64-3.8/jnius/env.py" ]; then 
   # The signature must be created from anything that actually
    ...
    md5sum ./build/lib.linux-x86_64-3.8/jnius/__init__.py ./build/lib.linux-x86_64-3.8/jnius/env.py ./build/lib.linux-x86_64-3.8/jnius/reflect.py ./build/lib.linux-x86_64-3.8/jnius/signatures.py ./build/lib.linux-x86_64-3.8/jnius/src/org/jnius/NativeInvocationHandler.java ./build/lib.linux-x86_64-3.8/jnius/jnius.cpython-38-x86_64-linux-gnu.so
	#echo Succ
else
